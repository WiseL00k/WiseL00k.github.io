...
$.ajax({
    ...
    data: {
        key: 'F6TBZ-YWBWJ-GHKFS-DPL4W-FT64E-SMBG7',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.393116, 23.039404, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
